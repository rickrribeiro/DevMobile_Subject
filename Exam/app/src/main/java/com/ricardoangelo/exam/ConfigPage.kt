...
class ConfigPage : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val radio2 = findViewById(R.id.radio2) as RadioGroup
